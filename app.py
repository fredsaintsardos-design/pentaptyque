        ...
        for i, (dim, score) in enumerate(scores_100.items()):
            ...
            with cols[i]:
                ...
                <div style="text-align:center; padding:10px;">
                    <div style="font-size:12px; color:#6b7280;">{dim.upper()}</div>
                    <div style="font-size:28px; font-weight:700; color:{level_color};">{score}</div>
                    <div style="font-size:11px; color:#6b7280;">{level_label}</div>
                </div>
                """, unsafe_allow_html=True)
